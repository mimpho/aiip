...
Feature: Embeddings y retriever ChromaDB
  ...
  Background:
    Given ChromaDB está inicializado con la colección "familias_test"
  ...
  Scenario: Retrieval cross-lingual castellano sobre chunks en inglés
    Given la colección "familias_test" contiene chunks en inglés sobre primary immunodeficiency
