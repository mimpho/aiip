...
| ID | Tarea | Estado |
|---|---|---|
| T-01 | Preparación de datos (lista definitiva de 36 fichas, D-075) + Lote 1 — 13 fichas (Z→P, incluye XIAP) + 4 fichas de revisión ya resueltas (D-076: 22q11.2/DiGeorge + 3 subtipos de SCID) | 🔄 En progreso |
